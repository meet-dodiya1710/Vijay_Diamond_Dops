            ...
            <tbody>
               ...
               if (mysqli_num_rows($select_cart) > 0) {
                  while ($fetch_cart = mysqli_fetch_assoc($select_cart)) {
                     ...
                     <tr>
                        <td><img src="../admin/includes/uploads/<?php echo $fetch_cart['image']; ?>" height="100px"
                              width="100px" alt=""></td>
                        <td style="color: #fff;">
                        ...
                        // $sub_total = is_numeric($quantity) ? number_format($fetch_cart['price'] * $quantity) : 0;
                        // echo "&#8377;" . $sub_total . "/-";
                        // $grand_total += $sub_total; // Move this line here to correctly update the grand total
                        ?>
                        <!-- </td> -->
                        ...
                        <td style="color: #fff;">
                           ...
                           if (is_numeric($quantity) && is_numeric($price)) {
                              $sub_total = number_format($price * $quantity);
                              echo "&#8377;" . $sub_total . "/-";
                              $grand_total += $sub_total; // Move this line here to correctly update the grand total
                           } else {
                              echo "Invalid quantity or price"; // or handle the error accordingly
                           }
                           ?>
                        </td>
